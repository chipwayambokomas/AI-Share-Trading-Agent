...
def train(config: dict, trial_name_for_temp_checkpoint: str = "standalone_run"):
    set_seed(config["experiment"]["seed"])

    project_root = Path(config.get("project_root_dir", "."))
    temp_checkpoint_dir = project_root / "checkpoints/MLP/temp_trial_models"
    ...
    train_loader, val_loader, _, _ = load_data(config)
    ...
    return best_val_loss, str(current_trial_temp_checkpoint_path)
