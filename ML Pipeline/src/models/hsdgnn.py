...
# HSDGNN_block class remains unchanged.
...
class HSDGNN(nn.Module):
    ...
    def forward(self, source, return_adjs=False):
        # --- START OF FIX ---
        # The input 'source' tensor contains all 7 features. We should pass all of them
        # to the encoder blocks. The original code incorrectly sliced the last two off.
        ...
        node_embedding = self.node_embeddings * T_i_D_emb * D_i_W_emb
