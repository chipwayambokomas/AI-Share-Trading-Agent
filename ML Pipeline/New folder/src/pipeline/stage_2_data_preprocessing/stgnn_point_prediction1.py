# src/preprocessing/stgnn_point_prediction.py
...
def run(df, config):
    ...
    print_header("Stage 2: Preprocessing (STGNN POINT PREDICTION)")
    ...
    logger.info("STGNN point prediction preprocessing complete.")
