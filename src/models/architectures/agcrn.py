    ...
    def forward(self, x, init_state, node_embeddings):
        ...
        for i in range(self.num_layers):
            ...
            for t in range(seq_length):
                # The original AGCRNCell expects input of shape (B, N, D), but the loop gives (B, D).
                # The input to the encoder `x` is already in the correct (B, T, N, D) format.
...
class AGCRN(nn.Module):
    def __init__(self, num_nodes, input_dim, rnn_units, output_dim, horizon, num_layers, embed_dim, cheb_k, **kwargs):
