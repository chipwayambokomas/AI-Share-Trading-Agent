...
class gcn(nn.Module):
    def __init__(self,c_in,c_out,dropout,support_len=3,order=2):
        ...
        self.mlp = nn.Conv2d(c_in, c_out, kernel_size=(1, 1), padding=(0,0), stride=(1,1))
...
class GraphWaveNet(nn.Module):
    ...
    def forward(self, input):
        # Input shape: (batch, seq_len, num_nodes, features)
        # Required shape for convs: (batch, features, num_nodes, seq_len)
        ...
        # calculate the current adaptive adj matrix once per forward pass
